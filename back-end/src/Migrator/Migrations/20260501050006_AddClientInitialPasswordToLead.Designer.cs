...
namespace ShareFlow.Migrator.Migrations
{
    ...
    [Migration("20260501050006_AddClientInitialPasswordToLead")]
    partial class AddClientInitialPasswordToLead
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShareFlow.Domain.Entities.DividendRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("PlatformRevenueId")
                        .HasColumnType("uuid")
                        .HasColumnName("platform_revenue_id");
                    ...
                    b.HasIndex("InvestorUserId")
                        .HasDatabaseName("ix_dividend_records_investor_user_id");

                    b.HasIndex("PlatformRevenueId")
                        .HasDatabaseName("ix_dividend_records_revenue_id");

                    b.HasIndex("ProjectId")
                        .HasDatabaseName("ix_dividend_records_project_id");

                    b.HasIndex("SlotId");

                    b.HasIndex("Status")
                        .HasDatabaseName("ix_dividend_records_status");
            ...
            modelBuilder.Entity("ShareFlow.Domain.Entities.Wallet", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ShareFlow.Domain.Entities.WalletTransaction", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ShareFlow.Domain.Entities.WithdrawalRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ShareFlow.Domain.Entities.DividendRecord", b =>
                {
                    ...
                    b.HasOne("ShareFlow.Domain.Entities.PlatformRevenue", "PlatformRevenue")
                        .WithMany()
                        .HasForeignKey("PlatformRevenueId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
