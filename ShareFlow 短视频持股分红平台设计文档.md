...
运营方希望向外部投资客户**开放持股分红**：客户投入资金，获得项目持股比例，按比例参与后续分红收益。整个流程由公司**销售团队**负责对接和签约，客户完成电子签约后自动开通账号，通过**客户门户**查看收益、持股和申请提款。
...
- 客户端（境外实例）：英文为主、图表丰富，国际化体验，随时掌握投资收益
- 客户端（境内实例）：中文为主，对接国内支付和提款方式
...
### 4.1.1 投资名额（Slots）机制说明

| 配置项       | 示例值       | 说明                                          |
| ------------ | ------------ | --------------------------------------------- |
| 可售总股比   | 30%          | 运营方愿意出让的股比上限                      |
| 总名额份数   | 10 份        | 最多签 10 个投资客户                          |
...
| 9  | 境内实例语言     | ✅**全中文**（前端/合同/邮件全部中文）；后端开发时预置中文合同模板                                   |
